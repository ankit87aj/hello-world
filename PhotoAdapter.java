...
public class PhotoAdapter extends RecyclerView.Adapter<PhotoAdapter.PhotoViewHolder> {
    ...
    public PhotoAdapter(List<String> dataSet, Context context) {
        mDataSet = dataSet;
        mContext = context;
    }
    ...
    public void onBindViewHolder(final PhotoViewHolder holder, int position) {
        final String path = "content://worldline.com.foldablelayout.demo/demo-pictures/" + mDataSet.get(position);
        ...
        holder.mTextViewCover.setText(mDataSet.get(position).replace(".jpg", ""));
